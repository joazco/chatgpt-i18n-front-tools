...
import { fileTypes, intlLanguages } from "../translate/config";
...
import { compress, copy2Clipboard, prettierJson } from "../translate/utils";
...
const RewriteText: React.FC = (props) => {
    ...
    }, [originalContent, lang, fileType, extraPrompt, keyName, uniqKeyName, model]);
